...
- Name: tutor-voice-authenticated.spec.ts >> authenticated tutor narration >> operates the repaired curriculum, subject, ECC, and admin cards as named native buttons
- Location: e2e/tutor-voice-authenticated.spec.ts:52:3
...
Locator: getByRole('button', { name: /igcse edexcel/i })
Expected: "false"
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('button', { name: /igcse edexcel/i })
