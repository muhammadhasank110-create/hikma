...
- Name: tutor-voice-authenticated.spec.ts >> authenticated tutor narration >> uses the shared contrast-safe compact HIKMA brand in the authenticated app header
- Location: e2e/tutor-voice-authenticated.spec.ts:93:3
...
Locator: getByRole('link', { name: 'Hikma home' })
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByRole('link', { name: 'Hikma home' })
