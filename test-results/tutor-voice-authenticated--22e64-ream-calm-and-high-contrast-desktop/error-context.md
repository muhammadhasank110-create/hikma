...
- Name: tutor-voice-authenticated.spec.ts >> authenticated tutor narration >> keeps learner dashboard surface tokens profile-aware for cream, calm, and high contrast
- Location: e2e/tutor-voice-authenticated.spec.ts:43:3
