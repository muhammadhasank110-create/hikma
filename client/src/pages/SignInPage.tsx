...
export default function SignInPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!res.ok) { setError(data.error ?? "Sign in failed. Please check your email and password."); return; }
      navigate("/dashboard");
    } catch {
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-[45%] bg-[rgb(var(--nav-bg))] flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="space-y-6">
            <h1 className="text-4xl font-bold text-white leading-tight">
              Learning that<br />
              <span className="text-[rgb(var(--arrival-rail,180_60_80))]">meets you</span><br />
              where you are.
            </h1>
        ...
        <div className="relative z-10 space-y-3">
          {["IGCSE Edexcel · Qatar MoEHE", "WCAG 2.2 AA · MADA Qatar", "Arabic + English · RTL support"].map(tag => (
      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-background">
        <div className="w-full max-w-md space-y-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4" noValidate>
            ...
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs text-muted-foreground">Forgot password? <span className="text-primary cursor-default opacity-50" title="Coming soon">Reset</span></span>
              </div>
          ...
          <p className="text-center text-sm text-muted-foreground">
            ...
            <Link href="/signup" className="text-primary hover:underline font-medium">Create free account</Link>
          </p>
